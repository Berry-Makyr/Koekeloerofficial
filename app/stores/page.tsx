      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-xs sm:text-sm text-driftwood-600 max-w-2xl mx-auto leading-relaxed">
            Come browse in person at Great White Junction (Shop 2), explore our solid wood furniture, artisan coastal gifts, genuine leather footwear, and meet our warm team.
          </p>
        </div>
