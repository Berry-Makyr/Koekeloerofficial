...
import { Tag, MapPin, Truck, X, Sparkles } from 'lucide-react';
...
export default function AnnouncementBar() {
  ...
  const handleCopyCode = () => {
    applyCoupon('KOEKELOER10');
    navigator.clipboard?.writeText('KOEKELOER10');
    setCopied(true);
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
        ...
        <div className="flex items-center gap-4 text-sand-200">
          <div className="flex items-center gap-1.5">
            ...
            <span>Free Nationwide Delivery on orders over <strong>R1,200</strong></span>
          </div>
        ...
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center gap-1.5 bg-coastal-800/80 px-2.5 py-0.5 rounded-full border border-coastal-700">
            ...
            <span>Get 10% off with code:</span>
            <button
